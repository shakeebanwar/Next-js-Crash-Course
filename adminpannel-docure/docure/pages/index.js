                      ...
                      <table className="table table-hover table-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle"  src="/static/assets/img/doctors/doctor-thumb-01.jpg" alt="User Image" /></a>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/doctors/doctor-thumb-02.jpg" alt="User Image"  /></a>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/doctors/doctor-thumb-04.jpg" alt="User Image"  /></a>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/doctors/doctor-thumb-05.jpg" alt="User Image"  /></a>
                      ...
                      <table className="table table-hover table-center mb-0">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/patients/patient1.jpg" alt="User Image"  /></a>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/patients/patient2.jpg" alt="User Image"  /></a>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/patients/patient3.jpg" alt="User Image"  /></a>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/patients/patient4.jpg" alt="User Image"  /></a>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="profile.html" className="avatar avatar-sm mr-2"><img className="avatar-img rounded-circle" src="/static/assets/img/patients/patient5.jpg" alt="User Image"  /></a>
