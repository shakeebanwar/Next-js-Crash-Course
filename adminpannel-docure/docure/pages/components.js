          ...
          <div className="comp-sec-wrapper">
                  ...
                  <div className="card">
                    ...
                    <div className="card-body">
                      <div className="avatar avatar-xxl">
                        ...
                        <img className="avatar-img rounded-circle" src="/static/assets/img/profiles/avatar-02.jpg" alt="User Image" />
                      </div>
                    ...
                    <div className="card-body">
                      <div className="avatar-group">
                        <div className="avatar">
                          ...
                          <img className="avatar-img rounded-circle border border-white" src="/static/assets/img/profiles/avatar-02.jpg" alt="User Image" />
                        </div>
                        <div className="avatar">
                        <img className="avatar-img rounded-circle border border-white" src="/static/assets/img/profiles/avatar-02.jpg" alt="User Image" />
                        </div>
            ...
            <section className="comp-section comp-buttons">
              ...
              <div className="card mb-4">
                ...
                <div className="card-body">
                  <button type="button" className="btn btn-primary"><span className="spinner-border spinner-border-sm mr-2" role="status" />Primary</button>
                  <button type="button" className="btn btn-secondary"><span className="spinner-border spinner-border-sm mr-2" role="status" />Secondary</button>
                  <button type="button" className="btn btn-success"><span className="spinner-border spinner-border-sm mr-2" role="status" />Success</button>
                  <button type="button" className="btn btn-danger"><span className="spinner-border spinner-border-sm mr-2" role="status" />Danger</button>
                  <button type="button" className="btn btn-warning"><span className="spinner-border spinner-border-sm mr-2" role="status" />Warning</button>
                  <button type="button" className="btn btn-info"><span className="spinner-border spinner-border-sm mr-2" role="status" />Info</button>
              ...
              <div className="row">
                <div className="col-12 col-md-6 col-lg-4 d-flex">
                  <div className="card flex-fill">
                    <div className="card-header">
                    <img className="card-img-top" src="/static/assets/img/img-01.jpg" alt="Card Image" />
                ...
                <div className="col-12 col-md-6 col-lg-4 d-flex">
                  <div className="card flex-fill">
                    ...
                    <img className="card-img-top" src="/static/assets/img/img-01.jpg" alt="User Image" />
                    <div className="card-header">
